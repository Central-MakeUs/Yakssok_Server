...
public class NotificationBodyConstants {
	...
	public static final String MEDICATION_NOT_TAKEN_BODY = "잔소리 듣기 전에 호딱 먹어요!";
	public static final String MEDICATION_NOT_TAKEN_BODY_FOR_FRIEND = "잔소리 장전 완료. 잔소리 보내봐요 우리.";
}
